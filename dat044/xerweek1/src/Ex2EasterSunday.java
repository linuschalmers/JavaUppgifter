...
public class Ex2EasterSunday {
    ...
    void program() {
         ...
         */
        if (date < 32){
            out.print("Easter Sunday for " + year + " is : " + date + "/3");
        }
        else if (date == 26){
            out.print("Easter Sunday for " + year + " is : 19/4");
        }
        else if (date == 25 && a == 16 && d == 28){
            out.print("Easter Sunday for " + year + " is : 18/4");
        }
        else{
            date = d + e - 9;
            out.print("Easter Sunday for " + year + " is : " + date + "/4");
        }
